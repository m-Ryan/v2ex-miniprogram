export const PRIMARY_COLOR = '#cc0000';
export const V2EX_URL = 'https://www.v2ex.com';
export const DEFAULT_TITLE = '摸鱼小程序';
export enum Pages {
...
export const DEFAULT_AVATAR =
    'https://cdn.v2ex.com/gravatar/dd85b15f72452ade86eca3eef52ae727?s=48&d=retro';
