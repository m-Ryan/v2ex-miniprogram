        ...
        const renderPagination = (
            <View className={styles.pagination}>
                <View
                    className={
                        isFirst
                            ? formatClassName(styles.prev, styles.disableIcon)
                            : styles.prev
                    }
                    onClick={() => this.onPrev()}
                >
                ...
                <View className={styles.content}>
                    <View
                        className={
                            onlyOne
                                ? styles.current
                                : formatClassName(styles.current, styles.active)
                        }
                    >
                        {current}
                    </View>
                    ...
                    {total > 0 ? (
                        <View className={styles.search}>
                            <Input
                                ...
                                value={searchPage}
                                onInput={e => this.onChangeSearhValue(e)}
                            />
                            <View
                ...
                <View
                    className={
                        isLast
                            ? formatClassName(styles.next, styles.disableIcon)
                            : styles.next
                    }
                    onClick={() => this.onNext()}
                >
